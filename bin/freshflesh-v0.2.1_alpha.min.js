...
FF.Animation.prototype.animate=function(a){a=this.timer.time/this.timer.timeout;console.log(this.animateLeft);console.log(this.animateOpacity);this.animateLeft&&(this.node.x-=this.animateLeft*a);this.animateRight&&(this.node.x+=this.animateRight*a);this.animateTop&&(this.node.y-=this.animateTop*a);this.animateBottom&&(this.node.y+=this.animateBottom*a);this.animateWidth&&(this.node.width+=this.animateWidth*a);this.animateHeight&&(this.node.height+=this.animateHeight*a);this.animateScale&&(this.node.scale+=
this.animateScale*a);this.animateOpacity&&(this.node.alpha+=this.animateOpacity*a)};FF.Animation.prototype.start=function(){this.timer.restart()};FF.EventManager=function(){var a=[];this.addEventListener=function(b,c){void 0===a[b]&&(a[b]=[]);-1===a[b].indexOf(c)&&a[b].push(c)};this.dispatchEvent=function(b){for(var c in a[b.type])a[b.type][c](b)};this.removeEventListener=function(b,c){var d=a[b].indexOf(c);-1!==d&&a[b].splice(d,1)}};
