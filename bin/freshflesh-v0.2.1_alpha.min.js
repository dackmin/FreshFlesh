...
FF.Animation.prototype.animate=function(a){a=a.remaining/this.timer.timeout*100;this.animateLeft&&(this.node.x-=this.animateLeft*a);this.animateRight&&(this.node.x+=this.animateRight*a);this.animateTop&&(this.node.y-=this.animateTop*a);this.animateBottom&&(this.node.y+=this.animateBottom*a);this.animateWidth&&(this.node.width+=this.animateWidth*a);this.animateHeight&&(this.node.height+=this.animateHeight*a);this.animateScale&&(this.node.scale+=this.animateScale*a);this.animateOpacity&&(this.node.alpha+=
